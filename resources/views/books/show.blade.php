...
<head>
  <title>Book {{ $book->id }} details</title>
</head>
        ...
        <tr>
          ...
          <td class="value">
            <form id="productInfo_currency" action="{{ route('books.show',$book->id)}}">
              ...
              <select id="currency_convert2" name="currency_convert2" onchange="currency_translate2()"
                id="productInfo_currency_select">
        ...
        <tr>
          <td class="field" colspan="2">
            <a href="javascript:;" onmousedown="singleLink_toggleSlide('extraInfo_Area');" id="extraInfo_link">
              <IMG src="/images/extraInfo_arrow.gif" border="0" width="15" height="14" id="extraInfo_img">&nbsp; More
              information
            </a>
          </td>
        </tr>
